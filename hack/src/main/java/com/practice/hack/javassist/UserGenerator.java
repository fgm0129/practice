package com.practice.hack.javassist;
...
public class UserGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        CtClass ctClassUser=classPool.makeClass("com.practice.hack.javassist.User");
        //定义name字段
        ...
        Object user = cons.newInstance("fangguangming");
        Method toString = clazz.getMethod("toString");
        System.out.println(toString.invoke(user));

        ctClassUser.writeFile("./hack/src/main/java");
